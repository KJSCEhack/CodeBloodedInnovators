...
public class GoogleCalendar {
    private static final String APPLICATION_NAME = "CollegeMate";
    ...
    private static final String CREDENTIALS_FILE_PATH = "/client_key.json";
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        ...
        Log.v("creds",clientSecrets.toString());
    ...
    public static Event addEvent() throws IOException, GeneralSecurityException {
